  ...
  <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      ...
      >
        ...
        >
          Creating seamless digital experiences through clean code, modern UI design, and scalable backend systems with a commitment to delivering quality, performance, and intuitive user interfaces.
        </motion.p>
        ...
        >
          ...
          <a
            href="https://mail.google.com/mail/?view=cm&fs=1&to=dakhane567@gmail.com&su=Talent%20Outreach&body=Hi%20Parag"
            target="_blank"
            className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200"
          >
